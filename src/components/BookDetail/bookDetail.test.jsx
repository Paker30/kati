...
describe('Book detail', () => {
    describe('render', () => {
        test('read', async () => {
            render(<BookDetail title="Valor y al toro" author="Francisco Ibañez" isReaded={true}/>);
        ...
        test('not read', async () => {
            render(<BookDetail title="Valor y al toro" author="Francisco Ibañez" isReaded={false} id="fake-id"/>);
