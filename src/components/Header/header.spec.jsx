...
const mockPopulateBooks = vi.fn().mockResolvedValue({ id: 'fake id', rev: 'fake rev'});
const mockStartAddingBook = vi.fn().mockResolvedValue({ id: 'fake id', rev: 'fake rev'});
const mockErrorAddingBook = vi.fn().mockResolvedValue({ id: 'fake id', rev: 'fake rev'});
